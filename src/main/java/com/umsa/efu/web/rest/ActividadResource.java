...
/**
 * REST controller for managing {@link com.umsa.efu.domain.Actividad}.
 */
@RestController
@RequestMapping("/api")
public class ActividadResource {
    ...
    public ResponseEntity<Actividad> updateActividad(@RequestBody Actividad actividad) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, actividad.getId().toString()))
            .body(result);
    }
