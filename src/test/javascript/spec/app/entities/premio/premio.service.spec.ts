...
describe('Service Tests', () => {
  describe('Premio Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Premio(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0, 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Premio', async () => {
      ...
      it('should update a Premio', async () => {
        const returnedFromService = Object.assign(
          {
            tituloPremio: 'BBBBBB',
            descripcion: 'BBBBBB',
      ...
      it('should return a list of Premio', async () => {
        const returnedFromService = Object.assign(
          {
            tituloPremio: 'BBBBBB',
            descripcion: 'BBBBBB',
      ...
      it('should delete a Premio', async () => {
